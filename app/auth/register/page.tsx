      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-xl border border-border bg-card p-6 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="name" className="body-sm mb-1.5 block font-medium">
                Full Name
              </label>
            ...
            <div>
              <label htmlFor="email" className="body-sm mb-1.5 block font-medium">
                Email Address
              </label>
              <div className="relative">
            ...
            <div>
              <label htmlFor="phone" className="body-sm mb-1.5 block font-medium">
                Phone Number
              </label>
              <div className="relative">
            ...
            <div>
              <label htmlFor="password" className="body-sm mb-1.5 block font-medium">
                Password
              </label>
              <div className="relative">
            ...
            <div>
              <label
                ...
                className="body-sm mb-1.5 block font-medium"
              >
                Confirm Password
              </label>
              <div className="relative">
