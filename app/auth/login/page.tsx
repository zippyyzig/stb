...
function LoginForm() {
  ...
  useEffect(() => {
    ...
    // Show Apple Sign-In on iOS devices (native app or web)
  ...
  const handleAppleSignIn = async () => {
    ...
    try {
      if (isNativeApp) {
        ...
        if (!nativeResult) {
          setErrorMessage("Apple Sign-In is not available. Please use another method.");
          setIsAppleLoading(false);
          return;
        }

        // Apple returns identityToken and user info
        // The 'user' field is the unique Apple user ID
